# Self Reflective RAG -> https://github.dev/campusx-official/self-rag
# Rag retrieves when even the retrival is unnecessary, thats why need Different Rags
# Here each step we chekc our on actions 
# questions like -> is retrival happened, is relevan the data, does generated answer can answer user query, is my model halocinate
...
#   2. source=./documents/Company_Profile.pdf, page=0, title=(anonymous)
