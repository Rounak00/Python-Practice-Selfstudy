# Human in the loop
# Pros -> Safety, Effeciency, Ethical alignment, Accuracy, Better UX
# Proper patterns -> Escalation pattern, Ambiguity classification patter, Action Approval  pattern,  output review/edit pattern
# main thing in HITL is interupt and command
