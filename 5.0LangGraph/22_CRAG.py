# CRAG -> Corrective Rag
# Why Need it? -> retrieve from Vector give anything now there is a high chance 
#                 we will get a bad response as the questio and reltead ans may not be there in vector

# Here we will have a retrival evaluator model and it actaully check all the docs and retrieved datas
# if not proper data in retrieve then it will do a web search, it may also add some retrieve data with web search

# Link -> https://github.dev/campusx-official/corrective-rag
